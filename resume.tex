...
\section{Technical skills}
    ...
    \cvcomputer{Languages / APIs / Tools - Familiar: }
           {C, C++, Android App development, Lua, Objective C, iOS app development, Java}
           {\textbf{Platforms}: }
           {GNU/Linux (Arch linux, Debian, Ubuntu \& Fedora), AWS, Heroku, OpenShift}

\section{Work Experience}
    \cventry{2016 Dec -- Till date}{Tarobites}{Software Engineer}{\small{San Francisco, CA - Remote employee}}{\small{\url{http://tarobites.com}}}{Worked on tarobites.com website, backend APIs, chef web interface, admin web interface and mobile apps.}
