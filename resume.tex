...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Languages / APIs / Tools:}{ Javascript, Python, PHP, MySQL, HTML/HTML5, CSS/CSS3, SCSS, Shell Scripting, Node, Less, MongoDB, Go Lang} \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Senior Software Engineer II}{2024 April \textbf{--} Now}
        \resumeItemListStart
           \resumeItem{Lead development of product recomendations track product in tandem with AI-ML team}
           ...
           \resumeItem{Sales Force Commerce Cloud and Sales Force PWA cartridges development for the Shipping Protection Insurance product.}
...
\section{Awards \& Achievements}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \\ \vspace{3pt}
        \textbf{Google Summer of Code:} {been a mentor for the years 2013, 2014, 2016 and 2024 }
        \\ \vspace{3pt}
